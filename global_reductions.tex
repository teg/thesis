...
%-----------------
\begin{convention}
To avoid ambiguity in Definitions~\vref{definition:FourBoxes}, \vref{definition:IsolatedSubflowRemoval} and \vref{definition:PathBreaker} we have establish the following convention:
