\TODO{Alessio: I made the following changes based on your comments
\begin{itemize}
\item mirrored the subflows in the contractum of Definition~\ref{definition:IsolatedSublfowRemoval} (now the numbering reads left-to-right, top-to-bottom);
...
\item Proposition~\vref{proposition:DerivationSubstitution}, since the formulae we substitute with in the proof of Theorem~\vref{theorem:SoundIsolatedSubflowRemoval} have size 1.
\end{enumerate}
\end{proof}
%----------
