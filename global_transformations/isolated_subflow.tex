...
\]
for some upper edges $\boldsymbol\epsilon$ and lower edges $\boldsymbol\iota$, where $\psi$ is a connected subflow not containing any interaction or cut vertices.
\end{definition}
