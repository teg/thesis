...
\begin{proof}
The statements follow by Definition~\ref{definition:IsolatedSubflowRemover} and
\begin{enumerate}
\item contradiction on Definition~\vref{definition:DerStreamlined} and Lemma~\vref{lemma:IsolatedSubflowRemovalPaths};
\item Definition~\ref{definition:DerStreamlined} and Lemma~\ref{lemma:IsolatedSubflowRemovalPaths};
\item Definition~\vref{definition:DerSimpleForm} and Lemma~\ref{lemma:IsolatedSubflowRemovalPaths};
