...
We define the reduction $\to_\fris$ (where $\fris$ stands for \emph{isolated subflow}) as follows, for any two atomic flows $\phi$ and $\psi$:
\[
\atomicflow{
...
\]
where $\psi$ is a connected subflow not containing any interaction or cut vertices.
\end{definition}
