...
\TODO{Make sure it is correct to refer to this kind of $ai$-decomposed form.}

Since the evidenced interaction and cut vertices belong to the same connected component, we can construct the following $\ai$-decomposed form of $\Phi$:
\[
\vlder{\Phi'}{}
{
