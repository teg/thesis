...
( 8, 6)*{\afvjdm4{}{}};
%-
(-9, 2)*{\aflabelright\ppl};
(-5, 0)*{\affr88};
(-1, 2)*{\aflabelleft\phi};
( 1, 2)*{\aflabelright\pmi};
( 5, 0)*{\affr88};
( 9, 2)*{\aflabelleft\psi};
%-
(-8,-6)*{\afvjum4{}{}};
...
\]
Then $\psi'$ is on simple form with respect to $\pi$ by Definition~\vref{definition:FlowNormalForms}.
\end{proof}
...
Given a derivation $\Phi$ and a polarity assignment for its atomic flow $\pi$, $\Simpl(\Phi,\pi)$ depends at most linearly on $\Phi$.
\end{lemma}
