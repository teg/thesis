...
\begin{enumerate}
\item there is a one-to-one map, $f$, from the upper edges of $\phi'$ to the upper edges of $\psi'$;
\item there is a one-to-one map, $g$, from the lower edges of $\phi'$ to the lower edges of $\psi'$; and
