...
%-------------------------------------------------------------------------------
\begin{proof}
We can proceed by structural induction on $\gamma$ and then on $\phi$. For the two cases of $\gamma\equiv\vls[\gamma'.\gamma'']$ and $\gamma\equiv\vls(\gamma'.\gamma'')$ we have to consider, for each vertex of $\phi$, one of the following situations:
