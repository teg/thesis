...
In Figure~\ref{figure:ReductionRules}, we define graphical expressions of the kind $r\colon\phi'\to\psi'$, where $r$ is a name and $\phi'$ and $\psi'$ are flows.
\end{definition}

\TODO{In Figures~\ref{figure:FlowReductionRules}, \ref{figure:ReductionRulesWeakening} and \ref{figure:ReductionRulesContraction} extend the edges so the atomic flows on either side of the arrow has equal height.}
...
The graphical expressions in Figure~\ref{figure:FlowReductionRules} are atomic-flow reduction rules.
\end{proposition}
...
The proof of the following theorem is essentially contained in Figures~\ref{figure:ReductionRulesWeakening} and \ref{figure:ReductionRulesContraction}.
