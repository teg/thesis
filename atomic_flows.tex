...
\Tom{Changed comparison with proof nets (Lutz approves).}
...
\Tom{Changed typesetting of $\up$ and $\lo$.}
...
\Tom{Extracted notation from defintion:}
...
\Tom{Changed informal explanation of juxtaposition of flows:}
...
\]
is obtained by juxtaposing (\emph{i.e.}, taking the disjoint sum, identifying $\top$ and $\bot$):
\begin{itemize}
\item three edges, 
