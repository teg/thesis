...
\TODO{Proof identity and beyond.}

\TODO{In these three years we could see that many people saw something in our atomic flows: }

\TODO{Publications: 1+1+3}

\TODO{Some words about conesquences of this work on proof identity and beyond. Computational interpretations, sharing , optimality, impl. comp. comple., modal logic, boxes}
