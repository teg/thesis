...
The results of this section, restricted to proofs, is also presented in the paper \emph{A Quasipolynomial Cut-Elimination Procedure in Deep Inference via Atomic Flows and Threshold Formulae} \cite{BrusGuglGundPari:09:Quasip:fk}, which was coauthored with Alessio Guglielmi, Paola Bruscoli and Michel Parigot.
