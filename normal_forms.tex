...
The most challenging aspect of streamlining is the elimination of paths from interaction to cut vertices. For this reason, we define the notion of \emph{weakly streamlined} atomic flows, which are flows with no paths from interaction to cut vertices. Chapter~\vref{chapter:GlobalReductions} is dedicated obtain weakly streamlined derivations.
