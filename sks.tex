...
\Tom{Removed $\{\swi\}$ from the stem of derivations.}
...
\Tom{Changed the following remark to illustrate the use of Lemma~\vref{lemma:SuperSwitchContraction}.}
