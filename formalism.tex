...
\TODO{Never use the term ``bureaucracy free'' or ``lack of bureaucracy''. Instead use ``bureaucracy reduced'' or ``reduced bureaucracy''. Moreover, the main benefit is the plasticity, not the bureaucracy.}

In this chapter I define a formalism based on the ideas of formalism A and call it (as suggested by Fran\c{c}ois Lamarche) \emph{the functorial calculus}. The reason to introduce a new formalism is that its lack of bureaucracy greatly simplifies the presentation of some of the more technical results in this thesis (in particular Section~\vref{subsection:ThresholdFormulae}).
