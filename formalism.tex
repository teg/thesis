...
\TODO{State that we consider derivations equal modulo associativity of vertical composition.}

\begin{lemma}\label{lemma:DerivationComposition}
...
\begin{definition}\label{definition:DerivationSize}
