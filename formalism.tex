...
\TODO{Few words of caution about Formalism A note.}
...
In this chapter I define a formalism based on the ideas of formalism A and call it (as suggested by Fran\c{c}ois Lamarche) \emph{the functorial calculus}. The reason to introduce a new formalism is that its lack of bureaucracy greatly simplifies the presentation of some of the more technical results in this thesis (in particular Section~\ref{subsubsection:ThresholdFormulae}).
...
%==================================================================
\subsection{The Functorial Calculus}\label{subsection:FunctorialCalculus}
...
%=======================================================================
\subsection{The Calculus of Structures}\label{subsection:CalculusOfStructures}
