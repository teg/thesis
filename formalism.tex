...
\TODO{Cite: \emph{On the Proof Complexity of Deep Inference}.}

The Definitions~\vrefrange{definition:Formula}{definition:InferenceRuleInstance} and Definition~\vref{definition:CoS} are based on definitions given in \cite{}.

\TODO{Explain that we can generalise.}
...
We will now present the calculus of structures and compare it briefly with the functorial calculus. The intuition behind derivations in the calculus of structures is that we rewrite formulae by applying inference rules inside a context.
