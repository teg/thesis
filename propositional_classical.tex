...
If $\alpha=\beta$, then (as remarked in \cite{}) there exists a derivation
\[
...
\begin{remark}
If we allow the use of all the rules of $\SKS$, and not only the down fragment, we can build a more compact proof than what we do in Theorem~\ref{theorem:SKSComplete}, by using the following as the inductive case:
\[
\vlderivation
{
 \vlin{\cod}{}
